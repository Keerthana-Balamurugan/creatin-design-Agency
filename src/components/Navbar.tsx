...
export function Navbar() {
  return (
    ...
    >
      <a href="#" className="flex items-center gap-2 text-beige font-mono text-sm tracking-widest uppercase">
      ...
      <a href="#contact" className="text-beige font-mono text-xs uppercase tracking-widest border border-white/40 rounded-full px-4 py-2 hover:bg-white hover:text-black transition-colors">
        Let's Start →
      </a>
    </motion.header>
  );
